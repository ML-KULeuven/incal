...
python api.py combine ../output/synthetic/ss/esummary $(join_by " " "${options_e[@]}") -p ../output/synthetic/ss/e
...
python api.py migrate ratio ../output/synthetic/ss/esummary/ -d ../synthetic/ss/10000 -s 1000 -f
python api.py migrate accuracy ../output/synthetic/ss/esummary/ -d ../synthetic/ss/10000 -s 1000 -f
